  ...
  render() {
    return (
      <Carousel dynamicHeight={true} className={styles.carouselCentered}>
        <div>
          <img src="/ghanaPics/ghanaCloth.jpg" alt="ghana cloth" />
          <p className="legend">Accra Merchant</p>
        </div>
        <div>
          <img src="/ghanaPics/ghanaStreet1.jpg" alt="ghana street" />
          <p className="legend">Nima street</p>
        </div>
        <div>
          <img src="/ghanaPics/ghanaStreet2.jpg" alt="ghana Street cloth" />
