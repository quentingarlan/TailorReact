...
const Measure = () => {
  ...
  const isInCart = (product) => {
    return !!cartItems.find(
      (item) =>
        item.clothImageName === product.clothImageName &&
    ...
    <div>
      <Container className={styles.contain}>
        <Row className="align-items-center">
          <Col lg="3">
            <img src="/measurePant.jpg" alt="mesure pantalon" />
          </Col>
          <Col lg="5">
            <Row className={styles.centerBottomMargin}>
              <h5>{t("autoSize")}</h5>
            </Row>
            <Row>
              <Col>
            ...
            <Row>
              ...
              <Col>
                <input
                  ...
                  onChange={(evt) => handleWaistSizeChange(evt)}
                  value={waistSize}
                ></input>
              </Col>
            </Row>
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  className={styles.inputs}
                  aria-label="tour de hanche"
                  onChange={(evt) => handleHipSizeChange(evt)}
                  value={hipSize}
                ></input>
              </Col>
            </Row>
            <Row>
              ...
              <Col>
                <input
                  type="text"
                  className={styles.inputs}
                  aria-label="fourche avant"
                  onChange={(evt) => handleCrotchSizeChange(evt)}
                  value={crotchSize}
                ></input>
              </Col>
            </Row>
            <Row>
              ...
              <Col>
                <input
                  ...
                  className={styles.inputs}
                  aria-label="Cuisse"
                  onChange={(evt) => handleThighSizeChange(evt)}
                  value={thighSize}
                ></input>
              </Col>
            </Row>
            <Row>
              ...
              <Col>
                <input
                  ...
                  className={styles.inputs}
                  aria-label="Longueur"
                  onChange={(evt) => handleLengthChange(evt)}
                  value={length}
                ></input>
              </Col>
            </Row>
          ...
          <Col>
            <YourCloths
              onClothChange={(evt) => handleClothImageNameChange(evt)}
              onClothLoad={(val) => handleClothImageNameChange(val)}
            ></YourCloths>
          </Col>
          <Col>
            <Zoom>
